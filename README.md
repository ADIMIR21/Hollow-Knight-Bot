...
| `teleport.py` | **Телепорт к боссам пантеона**: интерактивный выбор босса, рестарт, варп к арене |
...
Тот же выбор работает и в обучении — `HK_BOSS_SCENE` принимает алиасы и номера:
